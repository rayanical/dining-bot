          ...
          <div className="grid lg:grid-cols-2 gap-12 items-center">
            <div className="space-y-8">
              ...
              <h1 className="text-5xl lg:text-6xl font-bold text-gray-900 leading-tight">
                Your Personal{' '}
                <span className="text-[#881c1c] bg-clip-text">
                  Dining Companion
                </span>{' '}
                at UMass
              </h1>
              <p className="text-xl text-gray-600 leading-relaxed">
                Navigate dining halls with ease. Upload dietary constraints, set health goals,
                and get personalized meal plans tailored to your unique needs. Making healthy
                eating effortless for the entire UMass community.
              </p>
            ...
            <div className="max-w-md mx-auto rounded-2xl overflow-hidden border border-black/10 shadow-lg">
                ...
                <div className="bg-white p-5 space-y-4">
                    ...
                    <p className="font-medium text-gray-900">
                        I need high protein vegan options for today
                    </p>
                    </div>
                    ...
                    <p className="text-gray-800 mt-1">
                        Perfect! Based on your profile, I recommend the Tofu Scramble at
                        Worcester (28g protein) and Black Bean Burger at Franklin (24g
                        protein). Both align with your 2,200 calorie goal.
                    </p>
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center space-y-4 mb-16">
            <h2 className="text-4xl lg:text-5xl font-bold text-gray-900">
              ...
              <span className="text-[#881c1c]">Your Health</span>
            </h2>
            <p className="text-xl text-gray-600 max-w-3xl mx-auto">
              Everything you need to make informed dining decisions and achieve your nutrition goals
            </p>
          </div>
          ...
          <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-8">
            <Card className="border-2 hover:border-[#881c1c]/30 transition-all duration-300 hover:shadow-lg">
              <CardHeader>
                ...
                <CardDescription>
                  Upload restrictions like vegan, gluten-free, or specific allergies. Get meals that perfectly match your needs.
                </CardDescription>
              </CardHeader>
            </Card>
            ...
            <Card className="border-2 hover:border-[#881c1c]/30 transition-all duration-300 hover:shadow-lg">
              <CardHeader>
                ...
                <CardDescription>
                  Set weight loss, muscle gain, or maintenance goals. Track progress with personalized nutrition targets.
                </CardDescription>
              </CardHeader>
            </Card>
            ...
            <Card className="border-2 hover:border-[#881c1c]/30 transition-all duration-300 hover:shadow-lg">
              <CardHeader>
                ...
                <CardDescription>
                  Generate complete meal plans with calories and nutritional facts for breakfast, lunch, and dinner.
                </CardDescription>
              </CardHeader>
            </Card>
            ...
            <Card className="border-2 hover:border-[#881c1c]/30 transition-all duration-300 hover:shadow-lg">
              <CardHeader>
                ...
                <CardDescription>
                  Log foods and track past meals. The bot learns your preferences and creates an evolving nutrition profile.
                </CardDescription>
              </CardHeader>
            </Card>
            ...
            <Card className="border-2 hover:border-[#881c1c]/30 transition-all duration-300 hover:shadow-lg">
              <CardHeader>
                ...
                <CardDescription>
                  Ask questions like "Where's the best vegan protein today?" Get instant, accurate answers through chat.
                </CardDescription>
              </CardHeader>
            </Card>
            ...
            <Card className="border-2 hover:border-[#881c1c]/30 transition-all duration-300 hover:shadow-lg">
              <CardHeader>
                ...
                <CardDescription>
                  Identifies nutritional gaps in your diet and suggests meals to fill them for optimal health.
                </CardDescription>
              </CardHeader>
            </Card>
          </div>
          ...
          <div className="flex justify-center">
            <div className="space-y-6 text-center">
              <h2 className="text-4xl lg:text-5xl font-bold">
                Why UMass Students Love Our Bot
              </h2>
              <p className="text-xl text-red-100">
                Join other students in making healthier choices every day!
              </p>
      ...
      <section className="py-20 bg-white">
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 text-center space-y-8">
          <h2 className="text-4xl lg:text-5xl font-bold text-gray-900">
            ...
            <span className="text-[#881c1c]">Dining Experience?</span>
          </h2>
          <p className="text-xl text-gray-600">
            Start making smarter, healthier food choices today with personalized guidance from our AI-powered dining assistant.
          </p>
          ...
          <div className="">
            <div className="space-y-4 flex flex-col items-center text-center">
              ...
              <p className="text-sm text-gray-600">
                Your personal AI nutrition assistant for the UMass Amherst dining experience.
              </p>
            </div>
          </div>
        </div>
